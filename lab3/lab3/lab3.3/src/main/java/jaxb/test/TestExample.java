...
public class TestExample {
    ...
    public static void main(String[] args) {
        ...
        Department dept2 = new Department("D02", "SELL", "MINSK");
        Department dept3 = new Department("D02", "COUNT", "RUSSIA");
        List<Department> list1 = new ArrayList<Department>();
        list1.add(dept);
        list1.add(dept2);
        list1.add(dept3);

        Organisation organisation = new Organisation("O01", "GRUDKO ARTEM", "POSTAVY");
        List<Organisation> list2 = new ArrayList<Organisation>();
        list2.add(organisation);
        ...
        try {
            ...
            System.out.println("Write to file: " + "D:/web/lab3/dept-info.xml");
